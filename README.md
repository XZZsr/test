...
```
git clone https://code.cft.upmi.com.cn/cft/cft-admin.git

cd cft-admin

npm install //直接安装所有依赖
...
```
npm run build:dev  //开发环境打包 host:https://cft.upmi.com.cn/dev/
npm run build:test  //测试环境打包 host:https://cft.upmi.com.cn/test/
npm run build  //  生产环境打包  host:https://cft.upmi.com.cn/
